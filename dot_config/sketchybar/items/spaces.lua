...
local function apply_selection_style(space_item, index, selected)
    local accent = settings.items.default_color(index)
    local selected_color = settings.items.colors.selected_label or colors.white

    space_item:set({
        icon = {
            highlight = selected,
            color = selected and selected_color or accent
        },
        label = {
            highlight = selected,
            color = selected and selected_color or accent
        ...
        background = {
            color = selected and settings.items.colors.selected_background or settings.items.colors.background,
            border_color = selected and settings.items.colors.selected_border or accent,
...
for i, workspace in ipairs(workspaces) do
    ...
    local space = sbar.add("item", "item." .. i, {
        ...
        background = {
            ...
            border_color = selected and settings.items.colors.selected_border or settings.items.default_color(i)
        },
        popup = {
            background = {
                border_width = 5,
    ...
    spaces[i] = space
    apply_selection_style(space, i, selected)
